 ...
 */
export function errorResponse(code: string, message: string, status: number, errors?: any[]): Response {
...
export const ApiResponses = {
  ...
  forbidden: (message: string = 'Access forbidden') => errorResponse(
    'FORBIDDEN',
    message,
    403
  ),
  ...
  validationError: (message: string, errors?: any[]) => errorResponse(
    'VALIDATION_ERROR',
    message,
    400,
    errors

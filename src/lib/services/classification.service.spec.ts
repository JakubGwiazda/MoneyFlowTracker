...
describe('ClassificationService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [ClassificationService, RateLimiterService]
    });
  ...
  describe('classifyExpense - Success Scenario (TC-AI-001)', () => {
    it('should successfully classify expense to existing category with confidence >= 0.7', (done) => {
    ...
    it('should correctly parse model response and enrich with category data', (done) => {
    ...
    it('should validate confidence score is within 0-1 range', (done) => {
    ...
    it('should handle response with new category proposal (confidence < 0.7)', (done) => {
  ...
  describe('Rate Limiting', () => {
    it('should respect rate limiter and throw error when limit exceeded', (done) => {
      ...
      service.classifyExpense('Test expense', mockCategories).subscribe({
        ...
        error: (error: ClassificationError) => {
    ...
    it('should record request after successful API call', (done) => {
      const description = 'Test expense';
      const mockSession = {
        access_token: 'mock-token',
        user: { id: 'user-1' }
  ...
  describe('Error Handling', () => {
    ...
    it('should handle HTTP 429 rate limit error from API', (done) => {
      const mockSession = {
        access_token: 'mock-token',
        user: { id: 'user-1' }
      };
    ...
    it('should handle timeout error', (done) => {
      ...
      service.classifyExpense('Test', mockCategories).subscribe({
        ...
        error: (error: ClassificationError) => {
          ...
          expect(error.message).toContain('Zapytanie trwało zbyt długo');
          done();
        }
      });

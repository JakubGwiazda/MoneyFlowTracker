...
- Dwa zielone testy E2E: dodawanie pozycji i korekta kategorii  
- Kompletność funkcji: wszystkie wymienione w wymaganiach  
- Czas reakcji dodania pozycji <200 ms  
- Wskaźnik odzyskujności błędów walidacji = 0 błędów na 100 prób  
- >95% uptime usługi Supabase i API AI  
